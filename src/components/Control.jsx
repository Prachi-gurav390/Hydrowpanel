          ...
          <button onClick={handleButtonClick2} className="controlbtn1">
            ...
            >
              <g>
                ...
                />
                <path
                  d="M222.609 256c0 18.442 14.949 33.391 33.391 33.391V389.1c0 6.492-5.537 11.636-12.009 11.105C169.697 394.101 111.304 331.869 111.304 256s58.392-138.101 132.687-144.205c6.47-.532 12.009 4.611 12.009 11.104v99.71c0-18.442-14.949-33.391-33.391-33.391z"
                  fill="#FF6029"
                />
                <path
                  d="M247.7 288.351H114.938c-2.375-10.401-3.634-21.229-3.634-32.351 0-3.746.155-7.456.435-11.13h104.859c3.791 0 6.709 3.315 6.254 7.079-.16 1.328-.244 2.68-.244 4.051 0 14.497 10.665 27.581 25.091 31.272z"
                  fill="#B7441C"
                />
                <path
                  d="M256 55.652v166.957c-18.442 0-33.391 14.949-33.391 33.391H67.11c-6.369 0-11.488-5.337-11.122-11.696C62.043 139.099 149.277 55.652 256 55.652zM273.252 56.4c-5.688-.485-11.439-.748-17.252-.748v166.957c1.052 0 2.094.049 3.121.144 7.627.708 14.131-5.525 14.131-13.184V56.4z"
                  fill="#FFBC00"
                />
                <path
                  d="M289.391 58.438V256c0-18.442-14.95-33.391-33.391-33.391S222.609 237.558 222.609 256V58.438c10.861-1.823 22.013-2.786 33.391-2.786s22.53.963 33.391 2.786z"
                  fill="#E0A000"
                />
                <path
                  d="M280.326 1.141c121.968 11.497 219.037 108.565 230.534 230.534 1.23 13.05-9.065 24.326-22.174 24.326H289.391c0-18.442-14.949-33.391-33.391-33.391V23.315C256 10.205 267.275-0.089 280.326 1.141z"
                  fill="#92B703"
                />
              </g>
            </svg>
