...
// import srcimg from ".././Images/hydrowLogo.png";

const ProfileCard = ({ onClose }) => {
  const handleClose = () => {
    onClose();
  };
  let email = "pikugurav007@gmail.com";
  let name = "Prachi Gurav";
  let contact = "8308814374";
  return (
    <div className="fixed inset-0 z-20 flex justify-end items-start mt-14 ">
      <div className="profilecard bg-white w-70 rounded-lg shadow-lg overflow-hidden">
        <div>
